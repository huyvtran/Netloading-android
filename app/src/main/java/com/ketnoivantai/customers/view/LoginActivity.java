...
import com.ketnoivantai.customers.model.gcm.RegistrationIntentService;
import com.ketnoivantai.customers.presenter.LoginPresenter;
...
public class LoginActivity extends GenericActivity<LoginPresenter.View, LoginPresenter>
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.customers_activity_main);
